...
colnames(df) <- c("one","two","three","four","five",'six')
df
...
#add one row
ZZ <- c(53,765,8552,852,95,71,83,64,5810,2,56,25,12,76,32)
...
df <- data.frame('one' = c('w','a','w','a','a','w','b','w','b','w','b','b','a','b','a'), 'three' = c(4,8,9,7,10,53,11,67,74,72,74567,456,5,1,14), 'four' = c(36,42,57,77,24,56,77,33,43,47,78,12,45,36,1), 'five' = c(36777,4848,3862,192.34,387.34,37.45,267.5,23,245,34,78,15,3,66,24), 'six' = c(53,765,8552,852,95,71,83,64,5810,2,56,25,12,76,32))
print(df)
write.csv(df,C:\\Users\\Documents\\GitHub\\R4Eco_2022\\week1)
